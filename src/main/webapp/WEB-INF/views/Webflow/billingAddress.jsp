...
<div class="container">
	...
	<div class="row">
		...
		<form:form id="billingaddressform" method="POST" commandName="billingAddressModel">
		...
		<div class="form-group">
			...
			<form:input path="billingaddress_pincode" class="form-control" placeholder="Enter Pincode" required="required"></form:input>
		</div>
		<div class="form-group">
		...
		<input class="btn btn-success pull-right" name="_eventId_submitBillingAddress" type="submit" value="Save & Continue" />
